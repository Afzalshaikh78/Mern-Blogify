  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Your own <span className='text-zz'> blogging</span> <br/> platform.</h1>
      ...
      <img  alt="" className='absolute -top-50 -z-1 opacity-50'/>
    </div>
  )
}
